<!-- Source: https://skills.sh/zhanghandong/rust-skills/m15-anti-pattern -->
<!-- Install: npx skills add https://github.com/zhanghandong/rust-skills --skill m15-anti-pattern -->

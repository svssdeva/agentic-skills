<!-- Source: https://skills.sh/giuseppe-trisciuoglio/developer-kit/tailwind-css-patterns -->
<!-- Install: npx skills add https://github.com/giuseppe-trisciuoglio/developer-kit --skill tailwind-css-patterns -->

<!-- Source: https://skills.sh/apify/agent-skills/apify-ultimate-scraper -->
<!-- Install: npx skills add https://github.com/apify/agent-skills --skill apify-ultimate-scraper -->

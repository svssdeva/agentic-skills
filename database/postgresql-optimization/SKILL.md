<!-- Source: https://skills.sh/github/awesome-copilot/postgresql-optimization -->
<!-- Install: npx skills add https://github.com/github/awesome-copilot --skill postgresql-optimization -->

<!-- Source: https://skills.sh/langchain-ai/langchain-skills/langgraph-fundamentals -->
<!-- Install: npx skills add https://github.com/langchain-ai/langchain-skills --skill langgraph-fundamentals -->
